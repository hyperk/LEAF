...
void WCSimDetectorConstruction::SetHyperK_HybridmPMTGeometry()
{
  ...
  nID_PMTs2 = 19;
  //WCPMTVesselCycHeight = 38.*CLHEP::mm;    //option A, option B would be 277 mm
  //WCPMTVesselRadiusCurv = 342.*CLHEP::mm;  //needs to include the vessel thickness, as we construct from outside inwards.
  //WCPMTVesselRadius = 254.*CLHEP::mm;
  //WCPMTDistPMTVessel = 2*CLHEP::mm;
