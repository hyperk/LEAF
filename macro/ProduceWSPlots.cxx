...
void ProduceWSPlots(string fin = "hist.dump.root", string fout = "timePDF.root"){
    ...
    for(int f=0;f<nFiles;f++){
        ...
        //_f[f] = new TFile("plot_wcsim_hkhybridmpmt10pc_r14374_100Hz_4.2kHzBL_e5_center_full.root","read");
        ...
        for(int i=0;i<nPMTtypes;i++){
            ...
            HitTimeTOFProfile[f][i]->Fit(Form("gausExpoConv2%d_%d",f,i),"R");
            ...
            splineExpoConv2[f][i] = new TSpline3(Form("splineExpoConv2%d_%d",f,i),-limitFitGausExpo[i],limitFitGausExpo[i],gausExpoConv2[f][i],300);
